#!/bin/bash
#SBATCH --job-name=GCN_sort # Name of the job, can be useful for identifying your job later
...
srun nice -n 15 python GCN_wandb_cv.py --dataset data/csv/rds_under_8_severe_v2.csv --data_dir data/fetched/25751 --sweep_config configs/GCN_adam.yaml