#!/bin/bash
#SBATCH --job-name=SVM_mrmr       # Name of the job, can be useful for identifying your job later
...
srun nice -n 15 python SVM_wandb_cv.py --dataset data/csv/rds_under_8_severe_v2.csv --data_dir data/fetched/25751 --sweep_config configs/SVM.yaml